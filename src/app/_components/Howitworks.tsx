...
const HowItWorks: React.FC = () => {
  return (
    <div className="bg-blue_light_lg py-16 px-8">
      <div className="mx-auto flex flex-col md:flex-row items-center justify-center gap-0 lg:gap-40">
        ...
        <div className="relative flex flex-col space-y-12 max-w-[425px]">
          <h2 className="text-3xl font-georgia font-bold text-blue_primary">How It Works</h2>
          ...
          <div className="relative flex items-start space-x-6">
            <div className="relative flex flex-col items-center">
              <div className="w-11 h-11 md:w-14 md:h-14 rounded-full bg-blue_dark text-white flex items-center justify-center text-lg font-bold z-10">
                1
              </div>
            </div>
            <div>
              <h3 className="text-custom-16 md:text-xl font-semibold text-blue_dark">
                Book a Puppy Visit
              </h3>
          ...
          <div className="relative flex items-start space-x-6">
            ...
            <div>
              ...
              <p className="text-gray_dark text-custom-14 md:text-custom-16">
                <span className="font-semibold text-blue_dark">Reserve</span> your puppy with a
                ...
                or <span className="font-semibold text-blue_dark">Purchase</span> directly with full
